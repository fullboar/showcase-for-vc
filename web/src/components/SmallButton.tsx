...
export const SmallButton: React.FC<Props> = ({ text, onClick, disabled, loading }) => {
  return (
    <motion.button
      ...
      className={`text-sm bg-theme-blue dark:bg-white text-white font-semibold dark:text-theme-black py-1.5 px-6 rounded transition duration-300 ease-in-out transform shadow-sm ${
