...
export const ProfileCard: React.FC<Props> = ({ currentCharacter }) => {
  ...
  return (
    <div className="bg-white dark:bg-theme-darkgrey rounded-lg h-auto w-auto shadow-sm p-4 md:p-6 lg:p-8 lg:mb-4">
      <motion.div initial="hidden" animate="show" exit="exit" variants={fade}>
        <motion.img
          whileHover={{ scale: 1.05 }}
          className="m-auto h-32 w-32 md:h-36 md:w-36 p-4 rounded-full bg-theme-white dark:bg-theme-black ring-2 ring-white mb-4 shadow"
