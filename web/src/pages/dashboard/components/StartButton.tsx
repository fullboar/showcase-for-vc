  ...
  return (
    <div className="has-tooltip">
      <motion.button
        ...
        className={`text-sm bg-theme-blue dark:bg-theme-white text-white dark:text-black w-24 h-8 py-1.5 px-4 rounded font-semibold shadow-sm ${
      ...
      >
        {disabled && (
          <span className="hidden sm:block tooltip rounded shadow-lg p-1 bg-theme-darkgrey text-white w-48 -mt-16">
