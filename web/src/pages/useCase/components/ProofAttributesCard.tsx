...
export const ProofAttributesCard: React.FC<Props> = ({ entityName, requestedCredentials, proof, proofReceived }) => {
    ...
    return (
      <div className="block md:flex lg:block flex-1 lg:flex-col items-center justify-between pt-4" key={item.name}>
        <div className="flex flex-1 flex-row">
          {item.icon && (
            <div className="bg-theme-lightgrey dark:bg-theme-darkgrey rounded-lg p-2 w-12">
        ...
        <div className="flex flex-1 flex-col md:pl-16">
            ...
            return (
              <div key={prop} className="flex flex-row">
                <div
                  ...
                  className="flex-1-1 text-sm bg-theme-lightgrey dark:bg-theme-darkgrey p-1 px-2 rounded-lg my-1 md:m-2"
                >
          ...
          {item.predicates && (
            <div className="flex flex-row">
              <p className="flex-1-1 text-sm bg-theme-lightgrey dark:bg-theme-darkgrey p-1 px-2 rounded-lg m-2">
  ...
  return (
    <div className="flex flex-col bg-theme-white dark:bg-theme-black p-4 md:mb-8 rounded-lg shadow max-h-64 my-2 sm:max-h-72 md:max-h-96 overflow-auto">
