...
export const EndContainer: React.FC<Props> = ({ step }) => {
  ...
  return (
    <motion.div
      ...
      animate="show"
      exit="exit"
      className="flex flex-col bg-inset dark:bg-dark-inset rounded-lg p-6 md:p-12 xl:p-16 my-8 h-max min-h-full md:h-5/6 shadow-sm "
      style={style}
    ...
    >
      ...
      <div className="flex items-end self-end ">
        <Button
          text={localization.pages.useCase.components.endContainer.buttons.complete}
