...
export const ActionCard: React.FC<Props> = ({ items, title }) => {
  return items.length > 0 ? (
    <div className="flex flex-col bg-white dark:bg-theme-black m-4 px-4 py-2 w-72 md:w-96 rounded-lg shadow border border-1 border-theme-lightgrey dark:border-theme-darkgrey">
